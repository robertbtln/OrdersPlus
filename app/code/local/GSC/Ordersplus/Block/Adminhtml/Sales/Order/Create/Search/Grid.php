<?php
class GSC_Ordersplus_Block_Adminhtml_Sales_Order_Create_Search_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        if (Mage::getStoreConfig('ordersplus/salesinfo/createstock'))
        {
            $this->addColumn('stock_qty', array(
                'header'    => Mage::helper('sales')->__('Stock Qty'),
                'width'     => '50',
                'renderer'  => 'GSC_Ordersplus_Block_Adminhtml_Sales_Order_Create_Search_Renderer_Stock',
                'index'     => 'stock_qty'
            ));
        }
